...
class SqlQuery{
	...
	public function setString($value){
        ...
        $value = preg_replace(sql_regcase("/(from | select | insert | delete | where | drop | or | and | table  |tables|order|by|#|\*|--|'|\\\\)/"),"",$value);
		$value = trim($value);//limpa espaços vazio
	...
	public function setNumber($value){
		...
		if(!is_numeric($value)){
			throw new Exception($value.' não é numero');
		}
		$this->params[$this->idx++] = "'".$value."'";
	}
