...
<tr>
                                ...
                                <td class='text_padrao'>
                                    <?=DAOFactory::getCarteiraEstudantilDAO()->toString("escola","nome",$carteira_estudantil->escolaId)?>
                                </td>
                            </tr>
<tr>
                                <td height='36' align='right' class='text_bold_preto'>Aluno</td>
                                <td class='text_padrao'>
                                    <?=DAOFactory::getCarteiraEstudantilDAO()->toString("aluno","nome",$carteira_estudantil->alunoId)?>
                                </td>
                            </tr>
<tr>
                                    <td height='36' align='right' class='text_bold_preto'>Turma:</td>
                                    <td class='text_padrao'>
                                        <?=stripslashes($carteira_estudantil->turma)?>
                                    </td>
                                </tr>
<tr>
                                    <td height='36' align='right' class='text_bold_preto'>Turno:</td>
                                    <td class='text_padrao'>
                                        <?=stripslashes($carteira_estudantil->turno)?>
                                    </td>
                                </tr>
<tr>
                                    <td height='36' align='right' class='text_bold_preto'>Matricula:</td>
                                    <td class='text_padrao'>
                                        <?=stripslashes($carteira_estudantil->matricula)?>
                                    </td>
                                </tr>
<tr>
                                    <td height='36' align='right' class='text_bold_preto'>Foto:</td>
                                    <td class='text_padrao'>
                                        <?=stripslashes($carteira_estudantil->foto)?>
                                    </td>
                                </tr>
