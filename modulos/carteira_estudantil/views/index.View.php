	...
	<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
            ...
            <td valign="top">
				...
				<option value='escola_id' <? if(trim($campo)==trim($campo_sel)) echo'selected';?>>Escola</option>
				<option value='aluno_id' <? if(trim($campo)==trim($campo_sel)) echo'selected';?>>Aluno</option>
				<option value='turma' <? if(trim($campo)==trim($campo_sel)) echo'selected';?>>Turma</option>
		...
		<th>Turma</th>
            				...
            				<?
                            $posicao=1;
    						foreach($carteira_estudantils as $obj):
    						    $id = $obj->id;
						...
						$escola = DAOFactory::getCarteiraEstudantilDAO()->toString('escola','nome',$obj->escolaId);						$aluno = DAOFactory::getCarteiraEstudantilDAO()->toString('aluno','nome',$obj->alunoId);
                            ?>    
    							<tr bgcolor="">
						...
						<td class='text_padrao'><?=$aluno?></td>
												<td class='text_padrao'><?=$obj->turma?></td>
