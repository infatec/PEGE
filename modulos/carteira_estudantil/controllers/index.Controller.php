<?php	    
    ...
    $tr = DAOFactory::getCarteiraEstudantilDAO()->count(" WHERE 1=1 ".$criterio."");//TOTAL DE REGISTROS COM CRITERIO
    $carteira_estudantils = DAOFactory::getCarteiraEstudantilDAO()->queryAll(" *"," WHERE 1=1 ".$criterio." ORDER BY id DESC LIMIT ".$begin.",".$linhas_pagina." ");//PEGA TODOS OS REGISTROS COM O TOP
