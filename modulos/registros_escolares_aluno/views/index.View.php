...
<script src="<?=URL.'/modulos/registros_escolares_aluno/inc/'?>funcoes_modulo.js"></script>
                                ...
                                <table width="830" border="0" style="padding: 20px;" cellspacing="0" cellpadding="0" class="filtro">
                                    ...
                                    <tr id="dados_escola" style="display: none;">
                                        <td colspan="2">
                                            ...
                                            <div id="aluno" style="margin-top:12px;display: none;">
                                                Nome Aluno : <input name="nome" placeholder="Digite o nome de um aluno matriculado.." autocomplete="off" type="text" class="k-textbox" cod_aluno="" id="suggest_aluno" size="50" >
                                            </div>
