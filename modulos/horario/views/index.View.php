	...
	<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
            ...
            <td valign="top">
				...
				<option value='hora_inicio' <? if(trim($campo)==trim($campo_sel)) echo'selected';?>>Hora Início</option>
				<option value='hora_fim' <? if(trim($campo)==trim($campo_sel)) echo'selected';?>>Hora Fim</option>
    							...
    							<tr bgcolor="">
    								...
    								<td align="center">
                                        <?=$opcoes?>
												...
												<td class='text_padrao'><?=$obj->horaInicio?></td>
												<td class='text_padrao'><?=$obj->horaFim?></td>
