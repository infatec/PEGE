<?php	    
    ...
    $tr = DAOFactory::getTiposMaterialMecDAO()->count(" WHERE 1=1 ".$criterio."");//TOTAL DE REGISTROS COM CRITERIO
    $tipos_material_mecs = DAOFactory::getTiposMaterialMecDAO()->queryAll(" *"," WHERE 1=1 ".$criterio." ORDER BY id DESC LIMIT ".$begin.",".$linhas_pagina." ");//PEGA TODOS OS REGISTROS COM O TOP
