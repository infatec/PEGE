...
<div id="topo">
    ...
    <div id="titulo">
    <strong>Estado do Maranhão<br>
     Secretaria Municipal de Caxias<br> 
     Secretaria Municipal de Educação
  </strong></div>                 
</div>
	<hr /> 
    
    <div id="tituloTabela"><p><strong>Ficha Individual do Aluno<br />Educaçã de Jovens e Adultos - EJA<br />1°Segmento do Ensino Fundamental<br />(1°e 2° Ciclo)</strong></p></div>
    
    <div align="center"><p id="campos1">
    Nome da Escola_________________________________________________Turno M__ V__ N__<br />
    Aluno(a)____________________________________________________N°______Ano_________<br />
    Data Nasc___/___/___Localidade______________________________Estado_______________<br />
    </p></div>
    ...
    <div id="tabela" align="center">
        ...
        <th colspan="14">Avaliação Global/Bimestral/Médias e Faltas</th>
        ...
        <th rowspan="2">res.Semes</th>
        <th rowspan="2">Recu.Semes.</th>
    ...
    Caxias(MA)_______/________________/_____________<br /><br /><br />
