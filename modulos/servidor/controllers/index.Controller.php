<?php	    
    ...
    $tr = DAOFactory::getServidorDAO()->count(" WHERE 1=1 ".$criterio."");//TOTAL DE REGISTROS COM CRITERIO
    $servidors = DAOFactory::getServidorDAO()->queryAll(" *"," WHERE 1=1 ".$criterio." ORDER BY nome ASC LIMIT ".$begin.",".$linhas_pagina." ");//PEGA TODOS OS REGISTROS COM O TOP
