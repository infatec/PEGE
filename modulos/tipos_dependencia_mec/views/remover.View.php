                                    ...
                                    <td width="746" align="center" class="text_bold_azul">
                                        ...
                                        <form name="remover" method="post" action="">
                                            <table align="center" width="500" border="0" cellspacing="0" cellpadding="0">
                                                <? foreach($tipos_dependencia_mecs as $tipos_dependencia_mec) :?> 
                                                    <tr>
                                                        <td class="text_bold_preto"> 
                                                            <strong><?=$tipos_dependencia_mec->descricao?></strong>
                                                            <input type="hidden" name="id[]" value="<?=$tipos_dependencia_mec->id?>" >
                                                        </td>
                                                    </tr>
                                                <? endforeach;?>
                                                <tr>
