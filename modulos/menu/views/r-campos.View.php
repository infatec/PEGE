...
<tr>
                                    ...
                                    <td class='text_padrao'>
                                        <input name='nome' type='text' class='<?=$erro['nome']?>' id='nome' value='<?=stripslashes($menu_m->nome)?>'  size='50' maxlength='50' onKeyUp="ContaCaracteresCampo('nome', 'nomeT', 50);" />
...
<tr>
                                    ...
                                    <td class='text_padrao'>
                                        <input name='ordem' type='text' class='<?=$erro['ordem']?>' id='ordem' value='<?=stripslashes($menu_m->ordem)?>'  size='10) unsigne' maxlength='10) unsigne' onKeyUp="ContaCaracteresCampo('ordem', 'ordemT', 10) unsigne);" />
