	...
	<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
            ...
            <td valign="top">
				...
				<option value='descricao' <? if(trim($campo)==trim($campo_sel)) echo'selected';?>>Documento</option>
		...
		<th>Aluno</th>
						...
						$escola = DAOFactory::getCedDAO()->toString('escola','nome',$obj->escolaId);						$servidor = DAOFactory::getCedDAO()->toString('servidor','nome',$obj->servidorId);						$aluno = DAOFactory::getCedDAO()->toString('aluno','nome',$obj->alunoId);
                            ?>    
    							<tr bgcolor="">
    								...
    								<td align="center">
                                        <?=$opcoes?>
												...
												<td class='text_padrao'><?=$obj->descricao?></td>
