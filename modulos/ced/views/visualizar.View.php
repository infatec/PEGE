...
<tr>
                                    ...
                                    <td class='text_padrao'>
                                        <?=stripslashes($ced->descricao)?>
                                    </td>
                                </tr>
<tr>
                                <td height='36' align='right' class='text_bold_preto'>Escola</td>
                                <td class='text_padrao'>
                                    <?=DAOFactory::getCedDAO()->toString("escola","nome",$ced->escolaId)?>
                                </td>
                            </tr>
<tr>
                                <td height='36' align='right' class='text_bold_preto'>Servidor</td>
                                <td class='text_padrao'>
                                    <?=DAOFactory::getCedDAO()->toString("servidor","nome",$ced->servidorId)?>
                                </td>
                            </tr>
<tr>
                                <td height='36' align='right' class='text_bold_preto'>Aluno</td>
                                <td class='text_padrao'>
                                    <?=DAOFactory::getCedDAO()->toString("aluno","nome",$ced->alunoId)?>
                                </td>
                            </tr>
