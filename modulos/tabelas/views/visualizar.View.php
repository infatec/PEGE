...
<tr>
                                ...
                                <td class='text_padrao'>
                                    <?=DAOFactory::getTabelasDAO()->toString("tabela","nome",$tabelas->tabelaId)?>
                                </td>
                            </tr>
<tr>
                                <td height='36' align='right' class='text_bold_preto'>Menu</td>
                                <td class='text_padrao'>
                                    <?=DAOFactory::getTabelasDAO()->toString("menu","nome",$tabelas->menuId)?>
                                </td>
                            </tr>
<tr>
                                    <td height='36' align='right' class='text_bold_preto'>Nome:</td>
                                    <td class='text_padrao'>
                                        <?=stripslashes($tabelas->nome)?>
                                    </td>
                                </tr>
<tr>
                                    <td height='36' align='right' class='text_bold_preto'>Pasta:</td>
                                    <td class='text_padrao'>
                                        <?=stripslashes($tabelas->pasta)?>
                                    </td>
                                </tr>
