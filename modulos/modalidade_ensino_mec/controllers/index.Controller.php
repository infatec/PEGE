<?php	    
    ...
    $tr = DAOFactory::getModalidadeEnsinoMecDAO()->count(" WHERE 1=1 ".$criterio."");//TOTAL DE REGISTROS COM CRITERIO
    $modalidade_ensino_mecs = DAOFactory::getModalidadeEnsinoMecDAO()->queryAll(" *"," WHERE 1=1 ".$criterio." ORDER BY id DESC LIMIT ".$begin.",".$linhas_pagina." ");//PEGA TODOS OS REGISTROS COM O TOP
