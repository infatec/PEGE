                                    ...
                                    <td width="746" align="center" class="text_bold_azul">
                                        ...
                                        <form name="remover" method="post" action="">
                                            <table align="center" width="500" border="0" cellspacing="0" cellpadding="0">
                                                <? foreach($modalidade_ensino_mecs as $modalidade_ensino_mec) :?> 
                                                    <tr>
                                                        <td class="text_bold_preto"> 
                                                            <strong><?=$modalidade_ensino_mec->descricao?></strong>
                                                            <input type="hidden" name="id[]" value="<?=$modalidade_ensino_mec->id?>" >
                                                        </td>
                                                    </tr>
                                                <? endforeach;?>
                                                <tr>
