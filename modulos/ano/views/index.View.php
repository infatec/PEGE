...
<td valign="top">
	<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<th>Nome</th>
						...
						$nivel_ensino_mec = DAOFactory::getAnoDAO()->toString('nivel_ensino_mec','nome',$obj->nivelEnsinoMecId);
                            ?>    
    							<tr bgcolor="">
						...
						<td class='text_padrao'><?=$nivel_ensino_mec?></td>
												<td class='text_padrao'><?=$obj->codigo?></td>
												<td class='text_padrao'><?=$obj->nome?></td>
                                    <td class='text_padrao'><?=$obj->idadeCorreta?></td>
