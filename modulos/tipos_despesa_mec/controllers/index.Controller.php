<?php	    
    ...
    $tr = DAOFactory::getTiposDespesaMecDAO()->count(" WHERE 1=1 ".$criterio."");//TOTAL DE REGISTROS COM CRITERIO
    $tipos_despesa_mecs = DAOFactory::getTiposDespesaMecDAO()->queryAll(" *"," WHERE 1=1 ".$criterio." ORDER BY id DESC LIMIT ".$begin.",".$linhas_pagina." ");//PEGA TODOS OS REGISTROS COM O TOP
