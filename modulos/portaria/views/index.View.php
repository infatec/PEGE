	...
	<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
            ...
            <td valign="top">
				...
				<option value='rg' <? if(trim($campo)==trim($campo_sel)) echo'selected';?>>RG</option>
		...
		<th>Modalidade</th>
						...
						$servidor = DAOFactory::getPortariaDAO()->toString('servidor','nome',$obj->servidorId);						$aluno = DAOFactory::getPortariaDAO()->toString('aluno','nome',$obj->alunoId);
                            ?>    
    							<tr bgcolor="">
						...
						<td class='text_padrao'><?=$servidor?></td>
												<td class='text_padrao'><?=$obj->dataEntrada?></td>
												<td class='text_padrao'><?=$obj->rg?></td>
						<td class='text_padrao'><?=$aluno?></td>
												<td class='text_padrao'><?=$obj->modalidade?></td>
