            ...
            <td valign="top">
                <table width="100%" border="0" cellspacing="6" cellpadding="0">
                    ...
                    <tr> 
                        ...
                        <form action="<?=$GLOBALS["paginaAtual"]?>"  name="form" method="get" id="busca_normal">
                         <table width="830" border="0" cellspacing="0" cellpadding="0" class="filtro">
                            <tr>
                                ...
                                <td valign="bottom"><input type="submit" name="Procurar" id="Procurar" value="Procurar">
    							...
    							<tr bgcolor="">
    								...
    								<td align="center">
                                        <?=$opcoes?>
												...
												<td class='text_padrao'><?=$obj->endereco?></td>
												<td class='text_padrao'><?=$obj->inep?></td>
