                                               ...
                                               <td colspan="2" align="left" class="text_bold_preto">
                                                 <div id="caixa">
                                                     ...
                                                     <p id="abas">
                                                         ...
                                                         <a href="#aba1" class="selected">Dados Gerais</a>
                                                         <a href="#aba2">Configuração da Escola</a>
                                                     ...
                                                     <ul id="conteudos">
                                                         ...
                                                         <li id="aba1">
                                                            <?php include(DOMAIN_PATH."modulos/escola/views/r-campos.View.php")?>
                                                         </li>

                                                         <li id="aba2">
                                                            <?php include(DOMAIN_PATH."modulos/escola/views/r-camposConfiguracao.View.php")?>
                                                         </li>
