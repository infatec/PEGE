...
$pdf->campos = array("Nome","Inep","Bairro","Endereço","CEP");
...
$pdf->SetWidths(array(4,1.5,2,4,1.6,1.8,2,2,2.1,1.6,1.4,1.5,1.5,1.5,1.5,1.8,2.0));
...
foreach($escolas as $escola){
    ...
    $conteudo = array($escola["nome"],$escola["inep"],$escola["bairro"],$escola["endereco"],$escola["cep"]);
