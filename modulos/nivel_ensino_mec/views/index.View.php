	...
	<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
            ...
            <td valign="top">
				...
				<option value='codigo' <? if(trim($campo)==trim($campo_sel)) echo'selected';?>>Código</option>
		...
		<th>Nome</th>
            				...
            				<?
                            $posicao=1;
    						foreach($nivel_ensino_mecs as $obj):
    						    $id = $obj->id;
						...
						$modalidade_ensino_mec = DAOFactory::getNivelEnsinoMecDAO()->toString('modalidade_ensino_mec','nome',$obj->modalidadeEnsinoMecId);
                            ?>    
    							<tr bgcolor="">
						...
						<td class='text_padrao'><?=$modalidade_ensino_mec?></td>
												<td class='text_padrao'><?=$obj->codigo?></td>
