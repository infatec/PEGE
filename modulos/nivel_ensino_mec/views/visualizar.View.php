...
<tr>
                                ...
                                <td class='text_padrao'>
                                    <?=DAOFactory::getNivelEnsinoMecDAO()->toString("modalidade_ensino_mec","nome",$nivel_ensino_mec->modalidadeEnsinoMecId)?>
                                </td>
                            </tr>
<tr>
                                    <td height='36' align='right' class='text_bold_preto'>Código:</td>
                                    <td class='text_padrao'>
                                        <?=stripslashes($nivel_ensino_mec->codigo)?>
                                    </td>
                                </tr>
<tr>
                                    <td height='36' align='right' class='text_bold_preto'>Individual da escola?:</td>
                                    <td class='text_padrao'>
                                        <?=stripslashes($nivel_ensino_mec->individualEscola)?>
                                    </td>
                                </tr>
<tr>
                                    <td height='36' align='right' class='text_bold_preto'>Nome:</td>
                                    <td class='text_padrao'>
                                        <?=stripslashes($nivel_ensino_mec->nome)?>
                                    </td>
                                </tr>
