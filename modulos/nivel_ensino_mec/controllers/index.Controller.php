<?php	    
    ...
    $tr = DAOFactory::getNivelEnsinoMecDAO()->count(" WHERE 1=1 ".$criterio."");//TOTAL DE REGISTROS COM CRITERIO
    $nivel_ensino_mecs = DAOFactory::getNivelEnsinoMecDAO()->queryAll(" *"," WHERE 1=1 ".$criterio." ORDER BY id DESC LIMIT ".$begin.",".$linhas_pagina." ");//PEGA TODOS OS REGISTROS COM O TOP
