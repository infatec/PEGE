...
<script src="<?=URL.'/webroot/js/'?>jquery.tablesorter.js"></script>
    ...
    <script>
        ...
        function buscaEscolasNotas(campo){
        ...
        function selecionaEscolaNota(campo){
        ...
        function selecionarOutraEscolaNota(){
            $("#nome").val("");
            $("#escola_id").val('');
        ...
        function salvarNota(){
            ...
            var dados={
                dados: dados_aula,
                function_callback : "$.unblockUI();getNotas();$().toastmessage('showSuccessToast', 'Nota salva com sucesso!');",
                                ...
                                <table width="830" border="0" style="padding: 20px;" cellspacing="0" cellpadding="0" class="filtro">
                                    <tr>
                                        ...
                                        <td width="120">
                                            ...
                                            <input name="nome" autocomplete="off" type="text" id="nome" onKeyDown="buscaEscolasNotas(this)"  size="50" maxlength="50"></td>
                                        <td valign="bottom"> <button style="width: 200px;display: none;" id="btn_outra_escola" onclick="selecionarOutraEscolaNota()" type="button" class="bt">Selecionar outra escola</button> </td>
