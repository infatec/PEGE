	...
	<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
            ...
            <td valign="top">
				...
				<option value='inep' <? if(trim($campo)==trim($campo_sel)) echo'selected';?>>Inep</option>
				<option value='nis' <? if(trim($campo)==trim($campo_sel)) echo'selected';?>>Nis</option>
				       ...
				       <?if($tr>0):?>
                        <form action="remover.php"  name="form" method="post" style="margin-top:40px;margin-bottom:40px;margin-right:10px" >				
    						...
    						foreach($alunos as $obj):
                                ...
                                if(!empty($obj->foto)) $tooltip = '<a href="javascript:void()" style="text-decoration:none;color:#000000;padding-right:5px;" class="screenshot" rel="../../fotos/alunos/'.$obj->foto.'">'.$obj->nome.'</a>';
                                else $tooltip = $obj->nome;
                            ...
                            ?>    
    							<tr bgcolor="">
                                    ...
                                    <td class='text_padrao'><?=$tooltip?></td>
                                    <td class='text_padrao'><?=geradatabr1($obj->dataNascimento)?></td>
                                    <td class='text_padrao'><?=$obj->nomeMae?></td>
