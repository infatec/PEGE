<?php
    ...
    if($_POST["acao"])
    {
        ...
        if(empty($erro))
        {
            ...
            if(!empty($_POST['senha'])) $aluno->senha= geraSenha($_POST['senha']);
            if(!empty($_POST['foto']))
            {
                if(file_exists("../../fotos/alunos/".$_POST["foto_salva"])){
                    unlink("../../fotos/alunos/".$_POST["foto_salva"]);
                }
