                                ...
                                <tr> 
                                    ...
                                    <form action="<?=$GLOBALS["paginaAtual"]?>"  name="form" method="post" enctype="multipart/form-data">				
                                         <table width="830" border="0" cellspacing="2" cellpadding="0" class="borda" style="margin:5px" >
                                            <tr><td colspan="4" class="text_bold_azul">&nbsp;</td></tr>
                                            <? if (!empty($erro)):?>
                                            <tr align="center"> 
                                            ...
                                            <tr>
                                                ...
                                                <td width="78%" class="text_padrao" colspan="3">&nbsp;</td>
                                            </tr>
                                            <?php include(DOMAIN_PATH."modulos/ano_letivo/views/r-campos.View.php")?>
                                            <tr> 
                                                <td colspan="4" align="right" class="text_bold_preto">&nbsp;</td>
                                            </tr>
                                            <tr>
