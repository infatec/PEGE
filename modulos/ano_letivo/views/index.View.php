	...
	<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
            ...
            <td valign="top">
				...
				<option value='identificacao' <? if(trim($campo)==trim($campo_sel)) echo'selected';?>>Identificação</option>
		...
		<th>Situação</th>
						...
						$escola = DAOFactory::getAnoLetivoDAO()->toString('escola','nome',$obj->escolaId);
                            ?>    
    							<tr bgcolor="">
						...
						<td class='text_padrao'><?=$escola?></td>
												<td class='text_padrao'><?=$obj->identificacao?></td>
												<td class='text_padrao'><?=$obj->situacao?></td>
