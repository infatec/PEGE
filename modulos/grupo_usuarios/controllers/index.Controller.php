<?php	    
    ...
    $tr = DAOFactory::getGrupoUsuariosDAO()->count(" WHERE 1=1 ".$criterio."");//TOTAL DE REGISTROS COM CRITERIO
    $grupo_usuarioss = DAOFactory::getGrupoUsuariosDAO()->queryAll(" *"," WHERE 1=1 ".$criterio." ORDER BY id DESC LIMIT ".$begin.",".$linhas_pagina." ");//PEGA TODOS OS REGISTROS COM O TOP
