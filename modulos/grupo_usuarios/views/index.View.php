	...
	<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
            ...
            <td valign="top">
				...
				<option value='descricao' <? if(trim($campo)==trim($campo_sel)) echo'selected';?>>Descrição</option>
		...
		<th>Descrição</th>
            				...
            				<?
                            $posicao=1;
    						foreach($grupo_usuarioss as $obj):
    						    $id = $obj->id;
                            ...
                            ?>    
    							<tr bgcolor="">
    								...
    								<td align="center">
                                        <?=$opcoes?>
                                        <a class="tooltip" title="Permissões" href="configure.php?igu=<?=DAOFactory::getChavesDAO()->geraChave($id)?>"><img src="../../webroot/img_sistema/business_user_edit.png" border="0" alt="Editar" title="Editar" width="23" /></a>
                                    </td>
