	...
	<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
            ...
            <td valign="top">
				...
				<option value='tipo' <? if(trim($campo)==trim($campo_sel)) echo'selected';?>>Tipo</option>
				<option value='ordem' <? if(trim($campo)==trim($campo_sel)) echo'selected';?>>Ordem</option>
    							...
    							<tr bgcolor="">
    								...
    								<td align="center">
                                        <?=$opcoes?>
												...
												<td class='text_padrao'><?=$obj->tipo?></td>
												<td class='text_padrao'><?=$obj->ordem?></td>
