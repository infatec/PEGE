<?php	    
    ...
    $tr = DAOFactory::getConfiguracaoEscolaDAO()->count(" WHERE 1=1 ".$criterio."");//TOTAL DE REGISTROS COM CRITERIO
    $configuracao_escolas = DAOFactory::getConfiguracaoEscolaDAO()->queryAll(" *"," WHERE 1=1 ".$criterio." ORDER BY id DESC LIMIT ".$begin.",".$linhas_pagina." ");//PEGA TODOS OS REGISTROS COM O TOP
