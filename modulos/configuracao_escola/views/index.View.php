	...
	<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
            ...
            <td valign="top">
				...
				<option value='pred_pesq' <? if(trim($campo)==trim($campo_sel)) echo'selected';?>>Prédio Pesquisado</option>
		...
		<th>Situação da codificação</th>
            				...
            				<?
                            $posicao=1;
    						foreach($configuracao_escolas as $obj):
    						    $id = $obj->id;
						...
						$escola = DAOFactory::getConfiguracaoEscolaDAO()->toString('escola','nome',$obj->escolaId);
                            ?>    
    							<tr bgcolor="">
						...
						<td class='text_padrao'><?=$escola?></td>
												<td class='text_padrao'><?=$obj->statusCodificacao?></td>
