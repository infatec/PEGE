	...
	<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
            ...
            <td valign="top">
				...
				<option value='login' <? if(trim($campo)==trim($campo_sel)) echo'selected';?>>Login</option>
		...
		<th>Celular</th>
						...
						$grupo_usuarios = DAOFactory::getUsuariosDAO()->toString('grupo_usuarios','nome',$obj->grupoId);
                            ?>    
    							<tr bgcolor="">
						...
						<td class='text_padrao'><?=$grupo_usuarios?></td>
												<td class='text_padrao'><?=$obj->login?></td>
												<td class='text_padrao'><?=$obj->nome?></td>
												<td class='text_padrao'><?=$obj->fone?></td>
												<td class='text_padrao'><?=$obj->celular?></td>
